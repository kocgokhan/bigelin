...
public class CoupleCategoryRecyclerAdapter extends RecyclerView.Adapter<CoupleCategoryRecyclerAdapter.MyViewHolder> {

    ArrayList<Integer> personImages;
    Context context;

    public CoupleCategoryRecyclerAdapter(Context context, ArrayList<Integer> personImages) {
